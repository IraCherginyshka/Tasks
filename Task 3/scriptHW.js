...
function sortReviewDown(arr, left, right) {

    var refElem = parseInt(arr[Math.floor((left + right) / 2)].ratingRevievs);
    var l = left;
    var r = right;

    while (l <= r) {

        while (parseInt(arr[l].ratingRevievs) > refElem) {
            l++;
        }

        while (parseInt(arr[r].ratingRevievs) < refElem) {
            r--;
        }
...
function quickSortReviewDown(arrElem, left, right) {
    var index;
    Object.prototype.toString = function () {
        return `<br>RatingRevievs: ${this.ratingRevievs}; Name: ${this.name}; Price: ${this.price};`
    }

    if (arr.length > 1) {

        index = sortReviewDown(arr, left, right);

        if (left < index - 1) {
            quickSortReviewDown(arr, left, index - 1);
        }

        if (right > index) {
            quickSortReviewDown(arr, index, right);
        }
...
function sortReviewUp(arr, left, right) {
...
function quickSortReviewUp(arrElem, left, right) {
    var index;
    Object.prototype.toString = function () {
        return `<br>RatingRevievs: ${this.ratingRevievs}; Name: ${this.name}; Price: ${this.price};`
    }
    if (arr.length > 1) {
        ...
        index = sortReviewUp(arr, left, right);

        if (left < index - 1) {
            quickSortReviewUp(arr, left, index - 1);
        }

        if (right > index) {
            quickSortReviewUp(arr, index, right);
        }
...
var buttonReviewUp = document.getElementById("review_up");
buttonReviewUp.addEventListener("click", function () {
    theElement.innerHTML = quickSortReviewUp(arr, 0, arr.length - 1);
});

var buttonReviewDown = document.getElementById("review_down");
buttonReviewDown.addEventListener("click", function () {
    theElement.innerHTML = quickSortReviewDown(arr, 0, arr.length - 1);
});

(function changeArrPrice() {
    for (let i = 0; i < arr.length; i++) {
        if (typeof arr[i].price === 'object') {
            arr[i].price = arr[i].price.newUan + " - newUan, " + arr[i].price.oldUan + " - oldUan";
        }
    }

})();

function sortPriceUp(arr, left, right) {

    var refElem = parseInt(arr[Math.floor((left + right) / 2)].price.replace(" ", ""));
    var l = left;
    var r = right;

    while (l <= r) {

        while (parseInt(arr[l].price.replace(" ", "")) < refElem) {
            l++;
        }

        while (parseInt(arr[r].price.replace(" ", "")) > refElem) {
            r--;
        }
...
function quickSortPriceUp(arrElem, left, right, type) {
    var index;
    Object.prototype.toString = function () {
        return `<br>Price: ${this.price};  Name: ${this.name}; RatingRevievs: ${this.ratingRevievs}; `
    }
    if (arr.length > 1) {

        index = sortPriceUp(arr, left, right);


        if (left < index - 1) {
            quickSortPriceUp(arr, left, index - 1);
        }

        if (right > index) {
            quickSortPriceUp(arr, index, right);
        }
...
function sortPriceDown(arr, left, right) {
...
function quickSortPriceDown(arrElem, left, right, type) {
    var index;
    Object.prototype.toString = function () {
        return `<br>Price: ${this.price};  Name: ${this.name}; RatingRevievs: ${this.ratingRevievs}; `
    }
    if (arr.length > 1) {
        ...
        index = sortPriceDown(arr, left, right);


        if (left < index - 1) {
            quickSortPriceDown(arr, left, index - 1);
        }

        if (right > index) {
            quickSortPriceDown(arr, index, right);
        }
...
var buttonPriceUp = document.getElementById("price_up");
buttonPriceUp.addEventListener("click", function () {
    theElement.innerHTML = quickSortPriceUp(arr, 0, arr.length - 1);
});

var buttonPriceDown = document.getElementById("price_down");
buttonPriceDown.addEventListener("click", function () {
    theElement.innerHTML = quickSortPriceDown(arr, 0, arr.length - 1);
});
